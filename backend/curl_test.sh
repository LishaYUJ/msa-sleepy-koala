...
echo "TOKEN=$TOKEN"
curl -s -X PUT http://localhost:5125/api/settings/me -H "Authorization: Bearer $TOKEN" -H "Content-Type: application/json" -d '{"nickname":"test1","cutoffTime":"23:30","timeZoneId":"Pacific/Auckland"}'
